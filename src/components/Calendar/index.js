    ...
    return (
      <div onMouseUp={e => e.stopPropagation()} className={styles.monthAndYearWrapper}>
        {showMonthArrow ? (
          <button
            ...
            className={classnames(styles.nextPrevButton, styles.prevButton, {
              [styles.nextPrevButtonDark]: this.props.isDark,
              [styles.prevButtonDark]: this.props.isDark
            })}
        ...
        {showMonthAndYearPickers ? (
          <span
            className={classnames(styles.monthAndYearPickers, {
              [styles.monthAndYearPickersDark]: this.props.isDark
            })}
          >
        ...
        {showMonthArrow ? (
          <button
            ...
            className={classnames(styles.nextPrevButton, styles.nextButton, {
              [styles.nextPrevButtonDark]: this.props.isDark,
              [styles.nextButtonDark]: this.props.isDark
            })}
            onClick={() => changeShownDate(+1, 'monthOffset')}
    ...
    return (
      <div
        className={classnames(this.styles.calendarWrapper, className, {
          [this.styles.darkMode]: this.props.isDark
        })}
